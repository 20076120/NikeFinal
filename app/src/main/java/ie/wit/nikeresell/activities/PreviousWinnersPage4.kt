...
import ie.wit.nikeresell.adapters.ImageAdapterPrevious_Page_4
...
import kotlinx.android.synthetic.main.activity_previous_winners_page4.*

class PreviousWinnersPage4 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_previous_winners_page4)
        val viewPager = findViewById<ViewPager>(R.id.viewPager)
        val adapter = ImageAdapterPrevious_Page_4(this)
        ...
        infoButton3.setOnClickListener {
            ...
            val view = layoutInflater.inflate(R.layout.layout_popup_info4,null)
            window.contentView = view
            val imageView = view.findViewById<ImageView>(R.id.imageView)
            imageView.setOnClickListener {
                window.dismiss()
            }
            window.showAsDropDown(infoButton3)
        }
