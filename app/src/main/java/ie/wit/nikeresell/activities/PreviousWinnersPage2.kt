...
import ie.wit.nikeresell.adapters.ImageAdapterPrevious_Page_2
import kotlinx.android.synthetic.main.activity_previous_winners2.*
import kotlinx.android.synthetic.main.activity_previous_winners_page2.*

class PreviousWinnersPage2 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_previous_winners_page2)
        val viewPager = findViewById<ViewPager>(R.id.viewPager)
        val adapter = ImageAdapterPrevious_Page_2(this)
        ...
        infoButton1.setOnClickListener {
            ...
            val view = layoutInflater.inflate(R.layout.layout_popup_info2,null)
            window.contentView = view
            val imageView = view.findViewById<ImageView>(R.id.imageView)
            imageView.setOnClickListener {
                window.dismiss()
            }
            window.showAsDropDown(infoButton1)
        }
        button1.setOnClickListener{
            val intent = Intent(this, PreviousWinners::class.java)
            startActivity(intent)
        }
        val button3 = findViewById<Button>(R.id.pageButton3)
        button3.setOnClickListener{
            val intent = Intent(this, PreviousWinnersPage3::class.java)
            startActivity(intent)
        }
    }
